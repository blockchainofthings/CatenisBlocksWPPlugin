(function (context) {
    ...
    function CtnBlkSendFile(form, targetDevice, options, successPanelId, errorPanelId) {
        this.form = form;
    ...
    CtnBlkSendFile.prototype.sendReadFile = function (fileInfo) {
        ...
        context.ctnApiProxy.sendMessage(this.targetDevice, fileDataBuf.toString('base64'), this.options, function(error, result) {
            if (error) {
                ...
                _self.displaySuccess(__('File successfully sent.<br>Message Id: ', 'catenis-blocks') + result.messageId);
                _self.fileSent();
            }
        });
    };
